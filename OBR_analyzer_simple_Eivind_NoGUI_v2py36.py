...
SmallestDisplist=smth.numberandcyclesfromdisplist(self,disp=0.0,metadatadict={},findsmallestdispincycle=True)
...
save_time=2
RRef=True
base_filenames=["F_08_fibre 3_","F_08_fibre 4_"]#"F_08_fibre 1_","F_08_fibre 2_",
