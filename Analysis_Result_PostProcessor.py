...
if __name__ == '__main__':
	...
	base_location=r'C:\Users\eivinhug\OneDrive - NTNU\PhD\AbaqusModels\SplitDisk'

	metafile='SplitDisk_F_Layup_Results_Metadata.txt'
	
	measurementfile = 'Analysis_Line_TransPath_0_LE11_'
	
	plotvalue=8500
	
	constant_diff=10./1000. #mm
	
	if measurementfile=='Analysis_Line_TransPath_0_LE11_':
		startlength=0. #86.0#-23.9
		endlength=15.#-187.0#22.9
		midlelength=(startlength+endlength)/2
