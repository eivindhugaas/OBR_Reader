...
metadatatuple=smth.metadatatuple(metafile=os.path.join(base_location,'F04_MeasurementMetadata_7.txt'))
...
save_time=4
RRef=True
base_filenames=["F04_fibre 3_","F04_fibre 1_","F04_fibre 2_"]
